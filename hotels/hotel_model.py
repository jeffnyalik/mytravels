...
class Room(models.Model):
    ...
    room_type = models.ForeignKey(RoomType, on_delete=models.CASCADE, related_name="room_type", blank=True, null=True)
    capacity = models.PositiveIntegerField(default=1, blank=True, null=True)
    check_in_date = models.DateField(blank=True, null=True, auto_now_add=True)
    check_out_date = models.DateField(blank=True, null=True, auto_now_add=True)
